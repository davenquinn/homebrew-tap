# From https://gist.github.com/JonRowe/65575475af41f6026446b48018acc748

class PostgisAT11 < Formula
  desc "Adds support for geographic objects to PostgreSQL@11"
  ...
  def install
    ...
    args = [
      "--with-projdir=#{Formula["proj@11"].opt_prefix}",
